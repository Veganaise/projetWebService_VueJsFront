                ...
                <tbody>
                    <template v-for="user in users">
                        <tr v-for="(element, index) in user" :key="index">
                            ...
                            <td>
                                <img v-if="!editing" src="../assets/pencil-edit-button.png" @click="getAnUser(element.username)">
                                <img v-if="!editing" src="../assets/rubbish-bin.png" @click="deleteAnUser(element.username)">
                                <img v-if="editing" src="../assets/confirm.png" @click="editAnUser(element)">
                                <img v-if="editing" src="../assets/remove.png" @click="cancel()">
                            </td>
                        </tr>
                    </template>
                    <tr v-if="!editing && !creating">
                        ...
                        <td></td>
                        <td></td>
                        <td><img src="../assets/plus.png" @click="startToCreateAnUser()"></td>
                    </tr>
                    <tr v-if="!editing && creating">
                        ...
                        <td><img src="../assets/confirm.png" @click="createAnUser(username, password, role)"></td>
                    </tr>
                </tbody>
            </table>
        </div>
